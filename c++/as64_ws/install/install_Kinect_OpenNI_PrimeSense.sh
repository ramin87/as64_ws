...
echo -e $COLOR_GREEN"*** Kinect - OpenNI - PrimeSense installation ***"$COLOR_RESET
echo -e $COLOR_GREEN"*************************************************"$COLOR_RESET
...
echo -e $COLOR_GREEN"Downloading and installing OpenNI..."$COLOR_RESET
...
echo -e $COLOR_GREEN"Downloading and installing SensorKinect..."$COLOR_RESET
...
echo -e $COLOR_GREEN"Downloading and installing NITE..."$COLOR_RESET
...
# ======================================
echo -e $COLOR_GREEN"Installing some ros related packages..."$COLOR_RESET
# for Kinect
