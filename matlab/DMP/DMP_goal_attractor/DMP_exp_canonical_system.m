...
%
%     dx = -ax*x/tau * 1/(1 + a_px*norm(y-y_real)^2)
%
%   where:
...
classdef DMP_exp_canonical_system < handle
   properties
   ...
   methods
      ...
      %
      function can_sys = DMP_exp_canonical_system(x_end, tau, USE_PHASE_STOP, a_px)
      ...
      function x = get_continuous_output(can_sys, t, x0)
          ...
          x = x0*exp(-can_sys.a_x*t/can_sys.tau);
