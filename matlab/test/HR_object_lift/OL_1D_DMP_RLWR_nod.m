%% OL_1D_DMP_RLWR_nod class
%  OL: Object load.
%  1D: 1 dimension (gravity direction)
%  DMP_RLWR: DMP with recursive LWR
%  nod: No object dynamics are included.
%

classdef OL_1D_DMP_RLWR_nod < handle
    properties
        %% DMP parameters
        dmp % dmp model
    ...
    methods
        %% constructor
        function this = OL_1D_DMP_RLWR_nod()
            
            setMatlabPath();
            this.init();
            
            disp('Object lift - 1D - DMP with RLWR update - no object dynamics');
        ...
        function initProgramArguments(this)
            ...
            this.N_kernels = 40 * this.dmp_tau;
            ...
            this.sigma_dmp_w_min = 0;
            this.sigma_dmp_w_max = this.sigma_dmp_w*1;
            ...
            this.M_r = 1.0;
            this.K_r = this.K_z;
            this.D_r = this.D_z; %2*sqrt(cmd_args.M_r*cmd_args.K_r);
